...
![Loss Curves](https://raw.githubusercontent.com/vardanyantatevik/house-price-prediction/main/loss_curves.png)
...
![Predicted vs Actual](https://raw.githubusercontent.com/vardanyantatevik/house-price-prediction/main/pred_vs_actual.png)
...
![Feature Importance](https://raw.githubusercontent.com/vardanyantatevik/house-price-prediction/main/feature_importance.png)
...
Model is saved as `california_model.npz` and can be loaded later to make predictions on new data:
```python
